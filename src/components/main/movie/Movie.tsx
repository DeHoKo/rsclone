    ...
    return (
        <Container maxWidth="lg">
            <Box className={classes.root} component={'div'}>
                <CardMedia component={'img'} image={`${IMAGES_URL}${object.backdrop_path}`}/>
                {/*<CardMedia component={'img'} image={`${IMAGES_URL}${object.poster_path}`}/>*/}
                <Typography component='h1' gutterBottom>Name: {object.title}</Typography>
                <Typography component='div' gutterBottom>Genre: {object.genres.map(g => g.name).join()}</Typography>
                <Typography component='div' gutterBottom>Rating: {object.vote_average}/10</Typography>
                <Accordion>
                    <AccordionSummary
                ...
                <List component={'ul'} className={classes.customList}>
                    Cast: {credits.cast.map((c, i) =>
                    <ListItem key={i} className={classes.listItem}>
                        <CastItem classes={classes} image={c.profile_path ? `${IMAGES_URL}${c.profile_path}` : ''}
                                  title={c.name}
                ...
                <List component={'ul'} className={classes.customList}>
                    Production companies: {object.production_companies.map((pc, i) =>
                    <ListItem key={i} className={classes.listItem}>
                        <ListItemAvatar>
                ...
                <Typography component={'div'} gutterBottom>
                    ...
                    <TabPanel value={value} index={0}>
                        Backdrops:
                        <List component={'ul'} className={classes.customList}>
                            {images.backdrops.map(b => <ImageCard classes={classes} aspect_ratio={b.aspect_ratio}
                    ...
                    <TabPanel value={value} index={1}>
                        Posters:
                        <List component={'ul'} className={classes.customList}>
                            {images.posters.map(b => <ImageCard classes={classes} aspect_ratio={b.aspect_ratio}
                                                                file_path={b.file_path ? `${IMAGES_URL}${b.file_path}` : ''}
                                                                height={b.height}
                                                                vote_average={b.vote_average}
                                                                vote_count={b.vote_count}
